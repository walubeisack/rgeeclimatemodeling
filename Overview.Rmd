...
3. Create change maps using temperature and precipitation <br/>
4. Look at areas with low precipitation and high temperature for drought <br/>
5. Possibly incorporate a water index such as EWI
...
<br/>
- Overall study area map <br/>
- Maps of significant regions of the United States <br/>
- Plots for each time period showing the different variables at each point in time <br/>
- Maps and plots showing changes in temperature and precipitation between different time periods <br/>
